...
export type EstadoMedicoFilter = "todos" | "activos" | "inactivos";
...
interface MedicoFiltersProps {
  ...
  selectedEstado: EstadoMedicoFilter;
  onEstadoChange: (value: EstadoMedicoFilter) => void;
  resultsCount: number;
}
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <h2 className="text-lg font-semibold">Listado de médicos</h2>
      ...
      <div className="grid gap-3 lg:grid-cols-[1.3fr_220px_220px]">
        <div className="relative">
          ...
          <Input
            placeholder="Buscar por nombre, provincia, NIF o núm. colegiado"
            value={search}
        ...
        <select
          ...
          onChange={(e) => onEstadoChange(e.target.value as EstadoMedicoFilter)}
          className="h-11 rounded-2xl border bg-background px-4 text-sm outline-none transition focus:border-primary"
        >
